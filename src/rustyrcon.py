...
class MainWindow:
    ...
    def connect_builder_objects(self):
        ...
        self.textbuffer_chat.create_tag("peasant_chat", wrap_mode=Gtk.WrapMode.WORD_CHAR, foreground='white')
        self.textbuffer_chat.create_tag("server_chat", wrap_mode=Gtk.WrapMode.WORD_CHAR, foreground='white')
        self.textbuffer_chat.create_tag("peasant_uname", weight=Pango.Weight.BOLD, foreground='white')
        self.textbuffer_chat.create_tag("server_uname", weight=Pango.Weight.BOLD, foreground='white' )
